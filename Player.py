...
SHUFFLE = False
SHUFFLE_LEVEL = "folder" # Either "folder" or "photo" and defines whether all folders are shuffles or all photos are shuffled
TIMER = 9  # seconds
...
folder = "D:\\"
frame_object = frame.PhantomFrame(Window,target_folder=folder,timer=TIMER,shuffle=SHUFFLE,shuffle_level=SHUFFLE_LEVEL) # Initialising the frame area
